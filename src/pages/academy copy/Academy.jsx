...
function Academy(props) {
    console.log("Academy props",props)
        ...
        <div>
            <div style={{
                ...
                <div className="coursed-tent">
                    ...
                    <div className="coursed-rln">当前位置：<span className="coursed-index"> <Link to="/agent/dashboard" className='a-white'>首页</Link></span> - <span>Sales Partner Academy</span></div>
                </div>
            </div>

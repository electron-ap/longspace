        ...
        <>
            ...
            <div className="subpage-banner" style={{ backgroundImage: `url(${navInfo.banner})`, backgroundSize: "100% 100%" }}>
                <div className="subpage-tent">
                    ...
                    <div className="subpage-rln">当前位置：<span className="subpage-index"><Link to="/agent/dashboard" className='a-white'>首页</Link></span> - {navInfo.title}</div>
                </div>
            </div>
                        ...
                        displayWay === "grid" ? (
                            ...
                            <>
                                <div className='table-info-title'>
                                    ...
                                    <div className='info-title-sort' >按时间排序 <img src='../../assets/screen/dload.png' alt='' /></div>
